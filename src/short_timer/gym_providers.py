...
from short_timer import sugarwod, wodify
from short_timer.models import GymConnection, GymProvider, GymWod
...
def all_info() -> list[GymProviderInfo]:
    ...
    from short_timer.models import PROVIDER_PRIORITY
